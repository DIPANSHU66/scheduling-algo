...
const GitHubFooter = () => {
  return (
    <footer className="w-full z-50 border-t border-slate-200 dark:border-zinc-800 bg-white/40 dark:bg-slate-950/60 backdrop-blur-md transition-all duration-300">
      <div className="max-w-6xl mx-auto px-4 py-4 flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-0 text-slate-550 dark:text-slate-400">
        
        {/* GitHub Repository Link */}
        <a
          href="https://github.com/DIPANSHU66/scheduling-algo"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-2 hover:text-slate-800 dark:hover:text-white transition-colors min-w-0 flex-shrink"
        >
          ...
          <span className="font-semibold text-sm truncate">
            CPU Scheduler Simulator - GitHub Repo
          </span>
        </a>
        ...
        <div className="flex items-center gap-4 flex-shrink-0">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400 hover:text-yellow-600 dark:hover:text-yellow-400 transition-colors"
          >
            ...
            <span className="font-medium">Star this repo</span>
          </a>
        </div>
